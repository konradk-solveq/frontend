    ...
    const handleMeasurement = (layout, type) => {
        ...
        if (numTitle >= ELEMENTS_SUM && numText >= ELEMENTS_SUM) {
            ...
            if (path_propo < 1) {
                ...
                linePosX += (((path_propo - 1) / 2) * (img_h * .9)) * .7;
                console.log('%c linePosX:', linePosX, (path_propo - 1) / 2, img_h)
            }
            setH(linePosX);
