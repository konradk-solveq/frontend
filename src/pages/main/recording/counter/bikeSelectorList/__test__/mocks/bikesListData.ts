...
const bikesList: any = [
    {
        images: [
            'https://kross.eu/media/cache/gallery/images/31/31437/hexagon_2_0_black_red_orange_matte.png',
        ],
        params: [
            {
                name: 'Rama i widelec',
            ...
            },
            {
                name: 'Napęd',
                list: [
                    {name: 'KORBY', value: 'Cyclone (42/34/24T)'},
                    {
                        name: 'KASETA/WOLNOBIEG',
                        value: 'Shimano Tourney MF-TZ21 (14-28T)',
                    },
                ],
                customizable: false,
            },
            {
                name: 'Hamulce',
                list: [
                    {name: 'HAMULEC PRZÓD', value: 'V-BRAKE'},
                    {name: 'HAMULEC TYŁ', value: 'V-BRAKE'},
                ],
                customizable: false,
            },
            {
                name: 'Komponenty',
                list: [{name: 'CHWYTY', value: 'KROSS HANDY'}],
                customizable: false,
            },
            {
                ...
                list: [
                    {
                        name: 'WAGA [KG]',
                        value:
                            'XS: 14.64 kg; S: 13.8 kg; M: 13.93 kg; L: 14.2 kg',
                    },
                ],
                customizable: false,
            },
        ...
        description: {
            id: null,
            name: 'HEXAGON 2.0 2018',
            color: 'czarny / czerwony / pomarańczowy mat',
            colorCodes: ['#030303', '#FF0000', '#FFA500'],
            size: '26"',
            sku: 'KRHE2Z26X15M140003',
            serial_number: '1003196015',
            producer: 'Kross',
            purpose: {code: 'recreational', name: 'rekreacyjny'},
        },
        complaintsRepairs: [],
        warranty: {
            type: 'no-info',
    ...
    },
    {
        ...
        description: {
            ...
            producer: 'Kross',
            purpose: {code: 'city', name: 'miejski'},
        },
        complaintsRepairs: [],
        warranty: {
            type: 'no-info',
    ...
    },
    {
        ...
        description: {
            id: null,
            name: 'MC Voyage D53 Shitake Grey Mat',
            color: '',
            colorCodes: [],
            size: '',
            sku: 'MCVOZI28X53W001568',
...
export const bikesListData = () => {
    return bikesListToClass(bikesList);
};
