...
const image = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 416 202">
...
const ImgSvg: React.FC<IProps> = ({size, style}: IProps) => {
    return <AnimSvg style={[style]} source={image} />;
};
