...
We can use different builds for different environments. To make it work copy `.env` file to `.env.prod`, `.env.development` and `.env.test` files. Replace variables with proper values.
